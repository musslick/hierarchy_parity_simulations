...
% citation: Musslick S., Dey B., Özcimder K., Patwary M., Willke T. L., Cohen J. D. (2016). Controlled vs. Automatic Processing: A Graph-Theoretic Approach to the Analysis of Serial vs. Parallel Processing in Neural Network Architectures. Proceedings of the 38th Annual Meeting of the Cognitive Science Society.
    ...
    methods
        ...
        function [] = trainOnline(this, iterations, varargin)
            ...
            for i = 1:iterations
               ...
               this.MSE_log(i) = sum(MSE)/Ndatasets; % calculate mean-squared error for whole set of patterns
